...
MODULE  := github.com/qist/IPTV-static-scan
OUT_DIR := build
...
# 目标列表
TARGETS := \
	$(OUT_DIR)/IPTV-static-scan-linux-amd64 \
	$(OUT_DIR)/IPTV-static-scan-linux-arm64 \
	$(OUT_DIR)/IPTV-static-scan-linux-armv7 \
	$(OUT_DIR)/IPTV-static-scan-linux-386 \
	$(OUT_DIR)/IPTV-static-scan-linux-ppc64 \
	$(OUT_DIR)/IPTV-static-scan-linux-ppc64le \
	$(OUT_DIR)/IPTV-static-scan-linux-s390x \
	$(OUT_DIR)/IPTV-static-scan-windows-amd64.exe \
	$(OUT_DIR)/IPTV-static-scan-windows-arm64.exe \
	$(OUT_DIR)/IPTV-static-scan-windows-386.exe \
	$(OUT_DIR)/IPTV-static-scan-darwin-amd64 \
	$(OUT_DIR)/IPTV-static-scan-darwin-arm64 \
	$(OUT_DIR)/IPTV-static-scan-android-arm64 
